 ...
 */
public class MyFirstListAdapter  extends BaseAdapter{
    private List<FirstListTopic> mDatas;//热门主题的数据
    private Context mContext;

    public MyFirstListAdapter(List<FirstListTopic> data, Context context) {
        this.mDatas = data;
